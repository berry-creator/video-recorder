...
func TestListenWithFallbackIncrementsDefaultPort(t *testing.T) {
	var attempts []string
	listener, address, err := listenWithFallback("127.0.0.1:9000", func(_ string, candidate string) (net.Listener, error) {
		attempts = append(attempts, candidate)
		if candidate != "127.0.0.1:9002" {
	...
	if address != "127.0.0.1:9002" || len(attempts) != 3 {
